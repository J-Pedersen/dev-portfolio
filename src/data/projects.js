export const projects = [
...

  {
    ...
    tags: ['React', 'Bootstrap', 'JavaScript', 'Coursera', 'Figma', 'Inkscape', 'Photoshop'],
    techStack: ['React', 'Bootstrap', 'JavaScript', 'Coursera', 'Figma', 'Inkscape', 'Photoshop'],
    cardTech: ['React', 'Bootstrap', 'JavaScript', 'Figma'],
    media: [
...

  {
    ...
    icon: 'little_lemon-icon',
    tags: ['HTML', 'CSS', 'JavaScript', 'Coursera', 'Figma', 'Inkscape', 'Photoshop', 'Git', 'GitHub'],
    techStack: ['HTML', 'CSS', 'JavaScript', 'Coursera', 'Figma', 'Inkscape', 'Photoshop', 'Git', 'GitHub'],
    cardTech: ['HTML', 'CSS', 'JavaScript', 'Figma'],
    media: [
  ...
  // -----------------------------------------
  {
    ...
    icon: 'circuit-icon',
    tags: ['HTML', 'CSS', 'Photoshop', 'Git', 'GitHub'],
    techStack: ['HTML', 'CSS', 'Photoshop', 'Git', 'GitHub'],
