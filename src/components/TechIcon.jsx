...
const NAME_TO_BG = {
  Java: "bg-green-600/20 border border-brand dark:border-brand-soft",
  ...
  XML: "bg-yellow-200/20 border border-brand dark:border-brand-soft",
  ...
  Eclipse: "bg-slate-400/20 border border-brand dark:border-brand-soft",
  ...
  AWS: "bg-red-800/20 border border-brand dark:border-brand-soft",
