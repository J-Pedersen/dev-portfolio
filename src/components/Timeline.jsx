          ...
          <div key={year} className="space-y-8">
            ...
            <div
              className={`
                ...
                ${mobile
                  ? "border-b border-slate-300 dark:border-slate-700 bg-slate-300/80 dark:bg-slate-900/80 backdrop-blur shadow-sm"
                  : "sticky top-0 bg-slate-300/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-300/70 dark:border-slate-700/70 rounded-md shadow-sm"
                }
              `}
            >
              {year}
