          ...
          <div key={year} className="space-y-8">
            ...
            <div
              className={`
                ...
                ${mobile
                  ? "border-b border-slate-300 dark:border-slate-700 bg-slate-100 dark:bg-slate-900"
                  : "sticky top-0 bg-slate-100/70 dark:bg-slate-900/70 backdrop-blur border-b border-slate-300 dark:border-slate-700"
                }
              `}
            >
              {year}
